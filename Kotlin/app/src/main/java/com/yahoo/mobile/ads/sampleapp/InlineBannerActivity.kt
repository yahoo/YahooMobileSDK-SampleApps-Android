...
private val TAG = InlineBannerActivity::class.java.simpleName
private const val PLACEMENT_ID = "240372"

class InlineBannerActivity : AppCompatActivity(), InlineAdView.InlineAdListener {
