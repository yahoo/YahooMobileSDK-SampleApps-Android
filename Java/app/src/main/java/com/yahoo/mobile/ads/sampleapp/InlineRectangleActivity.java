...
public class InlineRectangleActivity extends AppCompatActivity implements InlineAdView.InlineAdListener {

	public static final String PLACEMENT_ID = "240379";

	private static final String TAG = InlineRectangleActivity.class.getSimpleName();
	...
	public void onLoaded(final InlineAdView inlineAdView) {
		...
		if (inlineAdView != null) {
			...
			Log.i(TAG, "Inline ad Creative Info: " + InlineRectangleActivity.this.inlineAdView.getCreativeInfo());

			adContainer.addView(InlineRectangleActivity.this.inlineAdView);

			Log.i(TAG, getResources().getString(R.string.load_successful));
			Toast.makeText(InlineRectangleActivity.this,
